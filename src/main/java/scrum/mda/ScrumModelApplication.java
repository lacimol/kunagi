...
public class ScrumModelApplication extends AGeneratorApplication {
	...
	public ApplicationModel getApplicationModel() {
		if (applicationModel == null) {
			...
			applicationModel.addAction("ShowMyWhiteboard", getBasePackageName() + ".tasks");
			applicationModel.addAction("HideMyWhiteboard", getBasePackageName() + ".tasks");
		}
	...
	public EntityModel getTaskModel() {
		if (taskModel == null) {
			...
			taskModel.addProperty("initialWork", int.class).setEditablePredicate("editable")
					.setTooltip("Time estimated on this Task.");
			taskModel
